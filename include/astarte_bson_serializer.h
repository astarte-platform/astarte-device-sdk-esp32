 ...
 *
 * @details This function has to be called to initialize and allocate memory for astarte_bson_serializer_t.
 ...
 *
 * @details This function might be used to get internal buffer without any data copy. Returned buffer will be invalid after serializer destruction.
 ...
 *
 * @details This function should be used to get a copy of the BSON document data. end of document should be called before calling this function.
 * @param bs a astarte_bson_serializer_t.
 ...
 *
 * @details This function appends a double value to the document. Stored value can be fetched using given key.
 * @param bs a astarte_bson_serializer_t.
 ...
 *
 * @details This function appends an int32 value to the document. Stored value can be fetched using given key.
 * @param bs a astarte_bson_serializer_t.
 * @param name BSON key, which is a C string.
 ...
 *
 * @details This function appends an int64 value to the document. Stored value can be fetched using given key.
 * @param bs a astarte_bson_serializer_t.
 * @param name BSON key, which is a C string.
 ...
 *
 * @details This function appends a binary blob to the document. Stored value can be fetched using given key.
 * @param bs a astarte_bson_serializer_t.
 * @param name BSON key, which is a C string.
 ...
 *
 * @details This function appends an UTF-8 string to the document. Stored value can be fetched using given key.
 *
 * @param bs a astarte_bson_serializer_t.
 * @param name BSON key, which is a C string.
 ...
 *
 * @details This function appends a date time value to the document. Stored value can be fetched using given key.
 * @param bs a astarte_bson_serializer_t.
 * @param name BSON key, which is a C string.
 ...
 *
 * @details This function appends a boolean value to the document. Stored value can be fetched using given key.
 * @param bs a astarte_bson_serializer_t.
 * @param name BSON key, which is a C string.
 ...
 *
 * @details This function appends a BSON subdocument to the document. Stored value can be fetched using given key.
 * @param bs a astarte_bson_serializer_t.
 * @param name BSON key, which is a C string.
