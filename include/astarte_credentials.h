...
typedef bool (*astarte_credentials_exists_t)(void *opaque, enum credential_type cred_type);
typedef astarte_err_t (*astarte_credentials_remove_t)(void *opaque, enum credential_type cred_type);
