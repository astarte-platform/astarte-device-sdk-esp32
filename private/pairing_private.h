 ...
 *
 * @param[in] device_id Unique identifier to use to obtain the device certificate.
 ...
 *
 * @param[in] device_id Unique identifier to use to verify the device certificate.
 * @param[in] cred_secr Credential secret to use as authorization token.
