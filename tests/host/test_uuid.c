...
{
    astarte_uuid_t namespace = { 0x6f, 0x2f, 0xd4, 0xcb, 0x94, 0xa0, 0x41, 0xc7, 0x8d, 0x27, 0x86,
        0x4c, 0x6b, 0x13, 0xb8, 0xc0 };
    ...
    astarte_uuid_t expected_out = { 0x3e, 0x73, 0xe1, 0xf2, 0x03, 0x63, 0x54, 0xe5, 0xb5, 0x96,
        0x23, 0x66, 0x17, 0x0f, 0xa3, 0xe5 };
    for (size_t i = 0; i < 16; i++)
