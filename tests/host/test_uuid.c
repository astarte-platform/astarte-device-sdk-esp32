...
void test_uuid_generate_v4(void)
{
    ...
    uuid_t expected_out = { 1, 2, 3, 4, 5, 6, 0x40 + 7, 8, 0x80 + 9, 10, 11, 12, 13, 14, 15, 16 };
    ...
    uuid_t expected_out_empty = { 0, 0, 0, 0, 0, 0, 0x40, 0, 0x80, 0, 0, 0, 0, 0, 0, 0 };
...
void test_uuid_generate_v5(void)
{
    ...
    uint8_t sha_result[20] = { 0x3e, 0x73, 0xe1, 0xf2, 0x03, 0x63, 0x04, 0xe5, 0x35, 0x96, 0x23,
        0x66, 0x17, 0x0f, 0xa3, 0xe5, 0, 0, 0, 0 };
    mbedtls_md_finish_ReturnArrayThruPtr_output(sha_result, 20);
...
void test_uuid_from_string(void)
{
    ...
    uuid_t first_uuid_v4 = { 0 };
    TEST_ASSERT_EQUAL(ASTARTE_RESULT_OK, uuid_from_string(first_uuid_v4_string, first_uuid_v4));
    uint8_t expected_first_uuid_v4_byte_array[UUID_SIZE] = { 0x44, 0xb3, 0x5f, 0x73, 0xcf, 0xbd,
        0x43, 0xb4, 0x8f, 0xef, 0xca, 0x7b, 0xae, 0xa1, 0x37, 0x5f };
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected_first_uuid_v4_byte_array, first_uuid_v4, UUID_SIZE);

    const char *second_uuid_v4_string = "6f2fd4cb-94a0-41c7-8d27-864c6b13b8c0";
    uuid_t second_uuid_v4 = { 0 };
    TEST_ASSERT_EQUAL(ASTARTE_RESULT_OK, uuid_from_string(second_uuid_v4_string, second_uuid_v4));
    uint8_t expected_second_uuid_v4_byte_array[UUID_SIZE] = { 0x6f, 0x2f, 0xd4, 0xcb, 0x94, 0xa0,
        0x41, 0xc7, 0x8d, 0x27, 0x86, 0x4c, 0x6b, 0x13, 0xb8, 0xc0 };
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected_second_uuid_v4_byte_array, second_uuid_v4, UUID_SIZE);

    const char *third_uuid_v4_string = "8f65dbbc-5868-4015-8523-891cc0bffa58";
    uuid_t third_uuid_v4 = { 0 };
    TEST_ASSERT_EQUAL(ASTARTE_RESULT_OK, uuid_from_string(third_uuid_v4_string, third_uuid_v4));
    uint8_t expected_third_uuid_v4_byte_array[UUID_SIZE] = { 0x8f, 0x65, 0xdb, 0xbc, 0x58, 0x68,
        0x40, 0x15, 0x85, 0x23, 0x89, 0x1c, 0xc0, 0xbf, 0xfa, 0x58 };
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected_third_uuid_v4_byte_array, third_uuid_v4, UUID_SIZE);

    const char *first_uuid_v5_string = "0575a569-51eb-575c-afe4-ce7fc03bcdc5";
    uuid_t first_uuid_v5 = { 0 };
    TEST_ASSERT_EQUAL(ASTARTE_RESULT_OK, uuid_from_string(first_uuid_v5_string, first_uuid_v5));
    uint8_t expected_first_uuid_v5_byte_array[UUID_SIZE] = { 0x05, 0x75, 0xa5, 0x69, 0x51, 0xeb,
        0x57, 0x5c, 0xaf, 0xe4, 0xce, 0x7f, 0xc0, 0x3b, 0xcd, 0xc5 };
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected_first_uuid_v5_byte_array, first_uuid_v5, UUID_SIZE);
}

void test_uuid_to_string(void)
{
    char first_uuid_v4_byte_array[UUID_STR_LEN + 1U] = { 0 };
    ...
    TEST_ASSERT_EQUAL(ASTARTE_RESULT_OK,
        uuid_to_string(first_uuid_v4, first_uuid_v4_byte_array, UUID_STR_LEN + 1U));
    ...
    char second_uuid_v4_byte_array[UUID_STR_LEN + 1U];
    const uuid_t second_uuid_v4 = { 0x6f, 0x2f, 0xd4, 0xcb, 0x94, 0xa0, 0x41, 0xc7, 0x8d, 0x27,
        0x86, 0x4c, 0x6b, 0x13, 0xb8, 0xc0 };
    TEST_ASSERT_EQUAL(ASTARTE_RESULT_OK,
        uuid_to_string(second_uuid_v4, second_uuid_v4_byte_array, UUID_STR_LEN + 1U));
    ...
    char first_uuid_v5_byte_array[UUID_STR_LEN + 1U];
    const uuid_t first_uuid_v5 = { 0x05, 0x75, 0xa5, 0x69, 0x51, 0xeb, 0x57, 0x5c, 0xaf, 0xe4, 0xce,
        0x7f, 0xc0, 0x3b, 0xcd, 0xc5 };
    TEST_ASSERT_EQUAL(ASTARTE_RESULT_OK,
        uuid_to_string(first_uuid_v5, first_uuid_v5_byte_array, UUID_STR_LEN + 1U));
...
void test_uuid_from_string_errors(void)
{
    ...
    TEST_ASSERT_EQUAL(ASTARTE_RESULT_INVALID_PARAM, uuid_from_string(uuid_string_too_long, uuid));

    const char *uuid_string_missing_hyphen = "44b35f73-cfbd-43b4-8fef0ca7baea1375f";
    TEST_ASSERT_EQUAL(
        ASTARTE_RESULT_INVALID_PARAM, uuid_from_string(uuid_string_missing_hyphen, uuid));

    const char *uuid_string_non_hex_digit = "44b35f73-cfLd-43b4-8fef-ca7baea1375f";
    TEST_ASSERT_EQUAL(
        ASTARTE_RESULT_INVALID_PARAM, uuid_from_string(uuid_string_non_hex_digit, uuid));
}
